...
## Branch structure
Active development happens on the main branch. This always contains the latest version. Each (pre-) release is tagged with the corresponding version. The [aspnetcore1](https://github.com/stewartm83/IdentityServer4/tree/aspnetcore1) and [aspnetcore2](https://github.com/stewartm83/IdentityServer4/tree/aspnetcore2) branches contain the latest versions of the older ASP.NET Core based versions.
...
Please use the [issue tracker](https://github.com/stewartm83/IdentityServer4/issues) for that. We only support the latest version for free. For older versions, you can get a commercial support agreement with us.
...
You can see a list of our current sponsors [here](https://github.com/stewartm83/IdentityServer4/blob/main/SPONSORS.md) - and for companies we have some nice advertisement options as well.
...
..and last but not least a big thanks to all our [contributors](https://github.com/stewartm83/IdentityServer4/graphs/contributors)!
