...
.. Note:: You can find the `latest SQL scripts <https://github.com/stewartm83/IdentityServer4/tree/main/src/EntityFramework.Storage/migrations/SqlServer/Migrations>`_ for SqlServer in the IdentityServer4.EntityFramework.Storage repository.
