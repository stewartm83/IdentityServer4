...
or use the `identity server authentication handler <https://github.com/stewartm83/IdentityServer4.AccessTokenValidation>`_ which can validate both JWTs and reference tokens.
